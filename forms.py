...
class RegistrationForm(FlaskForm):
    ...
    password = PasswordField('Password', validators=[DataRequired(), Length(min=8), EqualTo('confirm_password', "Passwords must match")], render_kw={"placeholder": "Enter Your Password"})
